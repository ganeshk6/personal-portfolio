    ...
    >
      ...
      <div className="w-full ">
        <div className="w-full h-auto flex flex-col lgl:flex-row justify-between">
          <ContactLeft />
          <div
            className="w-full lgl:w-[60%] h-full py-10 bg-gradient-to-r 
          from-[#1e2024] to-[#23272b] flex flex-col gap-8 p-4 lgl:p-8
            ...
            <form className="w-full flex flex-col gap-4 lgl:gap-6 py-2 lgl:py-5">
              {errMsg && (
                <p
                 ...
                 to-[#23272b] shadow-shadowOne text-center text-orange-500 
              ...
              {successMsg && (
                <p
                  className="py-3 bg-gradient-to-r from-[#1e2024] 
                to-[#23272b] shadow-shadowOne text-center text-green-500 
                text-base tracking-wide animate-bounce"
                >
                  {successMsg}
                </p>
